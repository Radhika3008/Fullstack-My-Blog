...
const withDB = async (operation, res) => {
  try {
    const client = await MongoClient.connect('mongodb+srv://radhikayadav30082004:radhika3008@cluster0.pp0yf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0');
